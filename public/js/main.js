...
var marker = L.marker([0,0], {icon: myIcon}).addTo(camb_map);
marker.bindPopup('Path 1');
var polyline = L.polyline([], polyline_options).addTo(camb_map);
var cnt = 0;

var marker_2 = L.marker([0,0], {icon: myIcon}).addTo(camb_map);
marker_2.bindPopup('Path 2');
var polyline_2 = L.polyline([], polyline_options).addTo(camb_map);
var cnt_2 = 0;

var marker_3 = L.marker([0,0], {icon: myIcon}).addTo(camb_map);
marker_3.bindPopup('Path 3');
var polyline_3 = L.polyline([], polyline_options).addTo(camb_map);
var cnt_3 = 0;

var marker_4 = L.marker([0,0], {icon: myIcon}).addTo(camb_map);
marker_4.bindPopup('Path 4');
var polyline_4 = L.polyline([], polyline_options).addTo(camb_map);
var cnt_4 = 0;

var marker_5 = L.marker([0,0], {icon: myIcon}).addTo(camb_map);
marker_5.bindPopup('Path 5');
var polyline_5 = L.polyline([], polyline_options).addTo(camb_map);
var cnt_5 = 0;

var marker_6 = L.marker([0,0], {icon: myIcon}).addTo(camb_map);
marker_6.bindPopup('Path 6');
var polyline_6 = L.polyline([], polyline_options).addTo(camb_map);
var cnt_6 = 0;

var marker_7 = L.marker([0,0], {icon: myIcon}).addTo(camb_map);
marker_7.bindPopup('Path 7');
var polyline_7 = L.polyline([], polyline_options).addTo(camb_map);
var cnt_7 = 0;
